...
export default function ExperimentWrapper() {
  ...
  useEffect(() => {
    async function resolveVariant() {
      ...
      if (override === 'standard') {
        setResolvedVariant('/create-listing')
        return
      }
      if (override === 'simple') {
  ...
  if (resolvedVariant === '/create-listing') {
    return <ProductListingWizard pageSlug="/create-listing-multi-arm" />
  }

  return <SimpleListingEntry pageSlug="/create-listing-multi-arm" />
}
