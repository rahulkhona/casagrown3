    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: 'Did you know 11.5 billion lbs of backyard produce is wasted every year? Millions can be fed if we save that. Join me and CasaGrown in stopping this waste.',
          url: inviteUrl,
        })
        return
      } catch (err) {
