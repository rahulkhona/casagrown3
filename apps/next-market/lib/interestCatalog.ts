...
export const EXHAUSTIVE_INTERESTS_CATALOG: InterestCatalogItem[] = [
  ...
  // ── VEGETABLES ──
  { id: 'heirloom_tomatoes', name: 'Tomatoes',        category: 'produce', displayCategory: 'Vegetables', image: '/products/heritage-tomatoes.png',         buyersCount: 84, sellersCount: 31, unit: 'lb' },
  ...
  { id: 'sweet_peppers',     name: 'Bell Peppers',    category: 'produce', displayCategory: 'Vegetables', image: '/products/bell-peppers.png',               buyersCount: 45, sellersCount: 16, unit: 'lb' },
  ...
  { id: 'yellow_squash',     name: 'Yellow Squash',   category: 'produce', displayCategory: 'Vegetables', image: `${BUCKET}/studio_yellow_squash.jpg`,        buyersCount: 21, sellersCount: 7,  unit: 'lb' },
  { id: 'eggplant',          name: 'Eggplant',        category: 'produce', displayCategory: 'Vegetables', image: `${BUCKET}/studio_eggplant.jpg`,             buyersCount: 18, sellersCount: 5,  unit: 'lb' },
  ...
  // ── FRUITS ──
  { id: 'avocados',          name: 'Avocados',        category: 'produce', displayCategory: 'Fruit', image: '/products/hass-avocado.jpg',    buyersCount: 55, sellersCount: 21, unit: 'bag' },
  ...
  { id: 'honeydew',          name: 'Honeydew',        category: 'produce', displayCategory: 'Fruit', image: `${BUCKET}/studio_honeydew.jpg`,      buyersCount: 19, sellersCount: 6,  unit: 'item' },
  ...
  // ── HERBS ──
  { id: 'basil',      name: 'Basil',       category: 'herbs', displayCategory: 'Herbs', image: '/products/fresh-basil.png',          buyersCount: 45, sellersCount: 17, unit: 'bunch' },
  { id: 'mint',       name: 'Mint',        category: 'herbs', displayCategory: 'Herbs', image: `${BUCKET}/studio_mint.jpg`,           buyersCount: 35, sellersCount: 13, unit: 'bunch' },
