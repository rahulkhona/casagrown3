...
export const EXHAUSTIVE_US_PRODUCE: ProduceItem[] = [
  ...
  { id: 'tangerines', name: 'Tangerines', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1557800636-894a64c1696f?w=600&auto=format&fit=crop&q=80', buyersCount: 25, sellersCount: 8, unit: 'bag' },
  { id: 'mandarins', name: 'Mandarins', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1611080626919-7cf5a9dbab5b?w=600&auto=format&fit=crop&q=80', buyersCount: 22, sellersCount: 7, unit: 'bag' },
  ...
  { id: 'hot_peppers', name: 'Hot Peppers', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1588252303782-cb80119abd6d?w=600&auto=format&fit=crop&q=80', buyersCount: 39, sellersCount: 14, unit: 'lb' },
  { id: 'chilies', name: 'Chilies', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=600&auto=format&fit=crop&q=80', buyersCount: 28, sellersCount: 9, unit: 'lb' },
  ...
  { id: 'yellow_squash', name: 'Yellow Summer Squash', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1590868309235-ea34bed7bd7f?w=600&auto=format&fit=crop&q=80', buyersCount: 21, sellersCount: 7, unit: 'lb' },
  ...
  { id: 'green_beans', name: 'Green Beans', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?w=600&auto=format&fit=crop&q=80', buyersCount: 36, sellersCount: 12, unit: 'lb' },
  { id: 'peas', name: 'Snap Peas', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1587735243615-c03f25aaff15?w=600&auto=format&fit=crop&q=80', buyersCount: 24, sellersCount: 8, unit: 'lb' },
  { id: 'kale', name: 'Kale', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1524179091875-bf98a9a6ae52?w=600&auto=format&fit=crop&q=80', buyersCount: 42, sellersCount: 15, unit: 'bunch' },
  { id: 'collard_greens', name: 'Collard Greens', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?w=600&auto=format&fit=crop&q=80', buyersCount: 22, sellersCount: 7, unit: 'bunch' },
  { id: 'lettuce', name: 'Lettuce', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1556801712-76c8eb07e99d?w=600&auto=format&fit=crop&q=80', buyersCount: 30, sellersCount: 10, unit: 'head' },
  { id: 'spinach', name: 'Spinach', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=600&auto=format&fit=crop&q=80', buyersCount: 28, sellersCount: 9, unit: 'lb' },
  { id: 'swiss_chard', name: 'Swiss Chard', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1591989330748-777649e84466?w=600&auto=format&fit=crop&q=80', buyersCount: 18, sellersCount: 5, unit: 'bunch' },
  { id: 'carrots', name: 'Carrots', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1598170845058-12f9a4a5f474?w=600&auto=format&fit=crop&q=80', buyersCount: 35, sellersCount: 12, unit: 'bunch' },
  { id: 'beets', name: 'Beets', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1593105544559-ecb03bf76f82?w=600&auto=format&fit=crop&q=80', buyersCount: 22, sellersCount: 7, unit: 'bunch' },
  ...
  { id: 'potatoes', name: 'Potatoes', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&auto=format&fit=crop&q=80', buyersCount: 40, sellersCount: 14, unit: 'lb' },
  { id: 'sweet_potatoes', name: 'Sweet Potatoes', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&auto=format&fit=crop&q=80', buyersCount: 28, sellersCount: 9, unit: 'lb' },
  { id: 'onions', name: 'Onions', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1618512496248-a07fe83aa8cb?w=600&auto=format&fit=crop&q=80', buyersCount: 52, sellersCount: 18, unit: 'bunch' },
  { id: 'scallions', name: 'Scallions', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1587049693270-e42753ee9d30?w=600&auto=format&fit=crop&q=80', buyersCount: 25, sellersCount: 8, unit: 'bunch' },
  ...
  { id: 'pumpkins', name: 'Pumpkins', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1508747703725-719777637510?w=600&auto=format&fit=crop&q=80', buyersCount: 33, sellersCount: 11, unit: 'item' },
  { id: 'winter_squash', name: 'Winter Squash', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1570586437263-ab629fccc818?w=600&auto=format&fit=crop&q=80', buyersCount: 20, sellersCount: 6, unit: 'item' },
  { id: 'broccoli', name: 'Broccoli', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=600&auto=format&fit=crop&q=80', buyersCount: 27, sellersCount: 8, unit: 'head' },
  { id: 'cauliflower', name: 'Cauliflower', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1568584711075-3d021a7c3ca3?w=600&auto=format&fit=crop&q=80', buyersCount: 19, sellersCount: 5, unit: 'head' },
  ...
  { id: 'nectarines', name: 'Nectarines', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1603569283847-be29b8b3bf1d?w=600&auto=format&fit=crop&q=80', buyersCount: 38, sellersCount: 13, unit: 'lb' },
  ...
  { id: 'pears', name: 'Pears', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1514756331983-2da38716304d?w=600&auto=format&fit=crop&q=80', buyersCount: 28, sellersCount: 8, unit: 'bag' },
  ...
  { id: 'blackberries', name: 'Blackberries', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1577069861033-55d04ace4ed0?w=600&auto=format&fit=crop&q=80', buyersCount: 45, sellersCount: 14, unit: 'pint' },
  { id: 'raspberries', name: 'Raspberries', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1577069860454-6726a6a84c67?w=600&auto=format&fit=crop&q=80', buyersCount: 38, sellersCount: 11, unit: 'pint' },
  { id: 'watermelon', name: 'Watermelon', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600&auto=format&fit=crop&q=80', buyersCount: 43, sellersCount: 14, unit: 'item' },
  { id: 'melons', name: 'Cantaloupe & Melons', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1595855759920-86582396756a?w=600&auto=format&fit=crop&q=80', buyersCount: 25, sellersCount: 8, unit: 'item' },
  ...
  { id: 'passionfruit', name: 'Passionfruit', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1534531173927-aeb928d54385?w=600&auto=format&fit=crop&q=80', buyersCount: 24, sellersCount: 7, unit: 'item' },
  { id: 'guavas', name: 'Guavas', category: 'produce', displayCategory: 'Fresh Produce', image: 'https://images.unsplash.com/photo-1536511135882-964200b3d685?w=600&auto=format&fit=crop&q=80', buyersCount: 18, sellersCount: 5, unit: 'item' },
