...
export const EXHAUSTIVE_US_PRODUCE: ProduceItem[] = [
  ...
  { id: 'chilies', name: 'Chilies', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_chilies.jpg', buyersCount: 28, sellersCount: 9, unit: 'lb' },
  ...
  { id: 'carrots', name: 'Carrots', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_carrots.jpg', buyersCount: 35, sellersCount: 12, unit: 'bunch' },
  ...
  { id: 'scallions', name: 'Scallions', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_scallions.jpg', buyersCount: 25, sellersCount: 8, unit: 'bunch' },
  ...
  { id: 'broccoli', name: 'Broccoli', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_broccoli.jpg', buyersCount: 27, sellersCount: 8, unit: 'head' },
  ...
  { id: 'asparagus', name: 'Asparagus', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_asparagus.jpg', buyersCount: 22, sellersCount: 6, unit: 'bunch' },
  ...
  { id: 'nectarines', name: 'Nectarines', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_nectarines.jpg', buyersCount: 38, sellersCount: 13, unit: 'lb' },
  ...
  { id: 'pears', name: 'Pears', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_pears.jpg', buyersCount: 28, sellersCount: 8, unit: 'bag' },
  { id: 'strawberries', name: 'Strawberries', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_strawberries.jpg', buyersCount: 62, sellersCount: 22, unit: 'flat' },
  { id: 'blueberries', name: 'Blueberries', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_blueberries.jpg', buyersCount: 54, sellersCount: 18, unit: 'pint' },
  { id: 'blackberries', name: 'Blackberries', category: 'produce', displayCategory: 'Fresh Produce', image: 'http://localhost:54321/storage/v1/object/public/interest-images/studio_blackberries.jpg', buyersCount: 45, sellersCount: 14, unit: 'pint' },
