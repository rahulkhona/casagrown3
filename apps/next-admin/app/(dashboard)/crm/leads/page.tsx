    ...
    <div className="crm-page">
      ...
      <div className="crm-table-wrap">
        <table className="crm-table">
          ...
          <tbody>
            {loading ? (
              <tr><td colSpan={8} className="crm-empty">Loading...</td></tr>
            ) : leads.length === 0 ? (
              <tr><td colSpan={8} className="crm-empty">No leads found.</td></tr>
            ) : leads.map(lead => (
      ...
      <style jsx>{`
        ...
        .crm-toolbar { display: flex; gap: 12px; margin-bottom: 16px; }
