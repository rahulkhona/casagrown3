...
const { data: captures } = await supabase.from('settlement_captures').select('*').eq('buyer_id', 'd0e7cd9d-9954-415f-8ebb-5e5ee42fdded');
console.log("Captures where user is buyer:", captures);
