...
('f1111111-1111-1111-1111-111111111111', CURRENT_DATE, 'Meyer Lemons', 'Sweet and fragrant lemons, completely pesticide free. Great for baking and lemonade.', 'produce', 4.00, 'bag', 20, '{"https://images.unsplash.com/photo-1611078716382-74ba416c11b0?q=80&w=600&auto=format&fit=crop"}', now(), 'approved', jsonb_build_array(to_char(CURRENT_DATE,'YYYY-MM-DD')), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb)),
('f1111111-1111-1111-1111-111111111111', CURRENT_DATE, 'Heritage Garlic Bulbs', 'Large, pungent hardneck garlic cured to perfection. Beautiful purple stripes.', 'produce', 8.50, 'bag', 5, '{"https://images.unsplash.com/photo-1594916301337-b43ecf8e026d?q=80&w=600&auto=format&fit=crop"}', now(), 'approved', jsonb_build_array(to_char(CURRENT_DATE,'YYYY-MM-DD')), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb)),

-- David's Products
('f2222222-2222-2222-2222-222222222222', CURRENT_DATE, 'Raw Wildflower Honey', 'Unfiltered, raw honey gathered from local spring wildflowers. Deep floral notes.', 'honey', 12.00, 'piece', 15, '{"https://images.unsplash.com/photo-1587049352847-4d4b124054da?q=80&w=600&auto=format&fit=crop"}', now(), 'approved', jsonb_build_array(to_char(CURRENT_DATE,'YYYY-MM-DD')), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb)),
('f2222222-2222-2222-2222-222222222222', CURRENT_DATE, 'Fresh Honeycomb', 'Gourmet honeycomb straight from the hive. Incredible paired with cheeses.', 'honey', 15.00, 'box', 4, '{"https://images.unsplash.com/photo-1587049352851-8d4e89134a4c?q=80&w=600&auto=format&fit=crop"}', now(), 'approved', jsonb_build_array(to_char(CURRENT_DATE,'YYYY-MM-DD')), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb)),

-- Elena's Products
('f3333333-3333-3333-3333-333333333333', CURRENT_DATE, 'Organic Baby Arugula', 'Spicy, tender arugula leaves. Harvested this morning, triple-washed.', 'produce', 5.00, 'bag', 10, '{"https://images.unsplash.com/photo-1593105553535-64f3d2f2d93e?q=80&w=600&auto=format&fit=crop"}', now(), 'approved', jsonb_build_array(to_char(CURRENT_DATE,'YYYY-MM-DD')), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb)),
('f3333333-3333-3333-3333-333333333333', CURRENT_DATE, 'Fresh Basil Bunches', 'Huge bunches of sweet Genovese basil. Pesto ready!', 'produce', 3.50, 'bag', 25, '{"https://images.unsplash.com/photo-1615486171448-4fd0531bd230?q=80&w=600&auto=format&fit=crop"}', now(), 'approved', jsonb_build_array(to_char(CURRENT_DATE,'YYYY-MM-DD')), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb), jsonb_build_object(to_char(CURRENT_DATE,'YYYY-MM-DD'), '[]'::jsonb));
