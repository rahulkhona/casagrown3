-- Add image_url to crm_recurring_user_incentives_blueprint
ALTER TABLE crm_recurring_user_incentives_blueprint ADD COLUMN IF NOT EXISTS image_url TEXT;

-- Update the RPC to return this new field to the landing page
