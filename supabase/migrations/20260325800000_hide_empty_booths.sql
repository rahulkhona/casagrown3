-- ============================================================================
-- Hide Empty Booths from the Marketplace
-- Modifies nearby_booths to strictly require at least 1 active matching product
-- before returning a real booth to the frontend, preventing empty shell booths
-- from cluttering the buyer feed.
-- ============================================================================
