-- ============================================================================
-- Restore Demo Dynamism (Session-Based Randomness)
-- Reverts the MD5 deterministic grouping back to random() so users see
-- fresh storefronts on intentional page reloads, while keeping
-- the `exclude_demos` CPU optimization for idle polling.
-- ============================================================================
...
BEGIN
  ...
  -- Check if buyer is in a blocked state (prevent displaying actual prices on demo)
