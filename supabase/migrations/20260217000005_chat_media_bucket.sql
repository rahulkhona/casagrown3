-- Fix modify_order — attribute message to buyer
-- Uses single delivery_instructions column (line 1 = address, rest = instructions)
...
begin
  ...
  -- Combine address (line 1) + instructions (rest) into single column
