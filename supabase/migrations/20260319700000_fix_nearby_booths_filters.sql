-- ============================================================================
-- Fix: Restore banned-user and expired-product filters in nearby_booths
--
-- The 20260318900000_market_state_blocks migration rewrote nearby_booths to
-- add state isolation but accidentally dropped:
--   1. is_banned check on booth owners
--   2. market_date / expires_at expiration check on products
--   3. products_never_expire setting from market_settings
-- This migration restores all three while keeping state isolation.
-- ============================================================================
