-- ============================================================================
-- Migration: Add product draft mode
-- ============================================================================

SET search_path TO public, extensions;

-- 1. Add column to market_products (defaults to false to preserve active listings)
ALTER TABLE market_products ADD COLUMN IF NOT EXISTS is_draft BOOLEAN NOT NULL DEFAULT false;

-- Create an index for draft filtering specifically for the seller dashboard
CREATE INDEX IF NOT EXISTS idx_market_products_seller_draft ON market_products(seller_id, is_draft);

-- 2. Update refresh_product_data
...
-- 3. Update nearby_booths to forcibly exclude draft products 
-- (Matches exact signature from 20260326100001_quarantine_nearby_booths)
