...
-- Buyer accepts offer → creates order → escrows buyer's points → system message
-- Delivery address is provided by the buyer at acceptance time (not on the offer)
-- ============================================================================
...
begin
  ...
  v_total_price := v_offer.quantity * v_offer.points_per_unit;
  ...
  -- Create a pending order from the offer
  insert into orders (
