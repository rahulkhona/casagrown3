-- ============================================================================
-- Migration: Add is_pro flag to profiles
-- 
-- Simple boolean to gate Pro features (multi-stand, catalog, market-day booths).
-- Default: false for all existing and new users.
-- Set to true when user subscribes to Pro.
-- ============================================================================
...
COMMENT ON COLUMN profiles.is_pro IS 'Whether user has Pro subscription. Gates multi-stand, catalog, and market-day booth features.';

-- 2. Update get_client_bootstrap to include is_pro in profile payload
