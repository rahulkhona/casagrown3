-- Fix create_order_atomic — attribute message to buyer instead of system
...
begin
  ...
  -- 6. Message attributed to buyer (was system message in original)
  ...
  -- Return result (matching expected edge function response shape)
  return jsonb_build_object(
    'orderId', v_order_id,
