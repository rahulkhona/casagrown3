...
BEGIN
  ...
  FROM (
    SELECT page_slug AS route, COUNT(*) AS cnt
    FROM (
...
COMMENT ON TABLE user_analytics IS 'DEPRECATED: Do not use for web analytics. Replaced by crm_page_visits and crm_page_events.';
