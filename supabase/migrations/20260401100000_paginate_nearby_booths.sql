-- ============================================================================
-- Migration: Paginate nearby_booths for scalability
-- ============================================================================
-- Adds p_limit and p_offset parameters to the nearby_booths RPC so the
-- market page can load booths in batches (infinite scroll). Demo booths
