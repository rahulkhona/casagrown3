...
import { Users, ShoppingCart, Gift, Leaf, Copy, Check, Send, Smartphone } from '@tamagui/lucide-icons'
...
export function InviteScreen() {
  ...
  const [inviteRewards, setInviteRewards] = useState({ signupPoints: 50, transactionPoints: 100 }) // mocked for now
